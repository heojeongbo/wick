...
require (
	...
	github.com/heojeongbo/wick/sink/azure v0.1.0
	github.com/heojeongbo/wick/sink/gcs v0.1.0
...
replace github.com/heojeongbo/wick/sink/gcs => ./sink/gcs

replace github.com/heojeongbo/wick/sink/azure => ./sink/azure
